...
npx skills add suvimatt/solopreneur-opc-skills --list

# Install one skill globally for Codex
npx skills add suvimatt/solopreneur-opc-skills -g -a codex -s validate-idea

# Install all skills for the four verified hosts
npx skills add suvimatt/solopreneur-opc-skills -g \
...
```bash
hermes skills tap add suvimatt/solopreneur-opc-skills
hermes skills install suvimatt/solopreneur-opc-skills/validate-idea
```

It can also install a single GitHub path directly:

```bash
hermes skills install suvimatt/solopreneur-opc-skills/skills/validate-idea
```
...
2. One default install command: `npx skills add suvimatt/solopreneur-opc-skills`.
